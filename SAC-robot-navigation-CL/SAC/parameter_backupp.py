...
def get_parameters():
    ...
    parser.add_argument('--expl_noise', default=0.3, type=float)                # Initial exploration noise starting value in range [expl_min ... 1]
    parser.add_argument('--expl_min', default=0.05, type=float)                 # Exploration noise after the decay in range [0...expl_noise]
